...
func main() {
	...
	tmpl = views.Must(views.ParseFS(templates.FS, "contact.gohtml", "layout-parts.gohtml"))
	r.Get("/contact", controllers.StaticHandler(tmpl))

	tmpl = views.Must(views.ParseFS(templates.FS, "faq.gohtml", "layout-parts.gohtml"))
